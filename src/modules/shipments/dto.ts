import { z } from 'zod';
import { bookingIdValidator, isoCurrencyCodeValidator, isoCountryCodeValidator } from '../../utils/validators';
...
export const createShipmentSchema = z.object({
  body: z.object({
    ...
    pricePerKgMinor: z.number().int().positive().optional().nullable(),
    pricePerItemMinor: z.number().int().positive().optional().nullable(),
    flatPriceMinor: z.number().int().positive().optional().nullable(),
